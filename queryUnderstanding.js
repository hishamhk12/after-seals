...
const INTENT_RETRIEVAL_HINTS = {
  workflow_sequence: "المقصود: تسلسل مراحل سير العمل الكامل لهذه الصفحة من البداية إلى النهاية",
  field_definition: "المقصود: تعريف وشرح المصطلح أو الحقل المذكور",
  next_step: "المقصود: الخطوة أو المرحلة التالية ضمن المسار الحالي لهذه الصفحة",
  previous_step: "المقصود: الخطوة أو المرحلة السابقة ضمن المسار الحالي لهذه الصفحة",
