...
function findNaturalSupportedAnswer(pageId, normalizedQuestion) {
  ...
  if (GLOBAL_SERVICES_QUESTIONS.has(normalizedQuestion)) {
    return "الخدمات الموجودة هي: خدمة التصميم، خدمة رفع القياسات، خدمة التوصيل، خدمة التركيب، خدمة التصنيع، خدمة الصيانة الميدانية، والتحويلات الداخلية / التحويلات الداخلية.";
  }
